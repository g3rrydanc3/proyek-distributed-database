...
<link rel="stylesheet" type="text/css" href="<?php  echo base_url() ?>/asset/css/bootstrap4/bootstrap.min.css">
...
<link href="<?php  echo base_url() ?>/asset/plugins/magnific-popup/magnific-popup.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php  echo base_url() ?>/asset/css/main_styles.css">
					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<div class="logo_container">
							<div class="logo">
								...
								<div class="logo_image"><img src="<?php  echo base_url() ?>asset/images/logo.png" alt=""></div>
							</div>
						</div>
						...
						<div class="search">
							<form action="#" class="search_form">
								...
								<button type="submit" class="search_button ml-auto ctrl_class"><img src="<?php  echo base_url() ?>asset/images/search.png" alt=""></button>
							</form>
						</div>
			...
			<div class="menu menu_mm">
				<div class="menu_search_form_container">
					<form action="#" id="menu_search_form">
						...
						<button id="menu_search_submit" class="menu_search_submit" type="submit"><img src="<?php  echo base_url() ?>asset/images/search_2.png" alt=""></button>
					</form>
				</div>
