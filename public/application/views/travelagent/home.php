		...
		<div class="card-body">
			<form action="" method="get">
				...
				<div class="input-group mb-3">
					...
					<div class="autocomplete" style="width:96%;">
						<input id="myInput" class="form-control" type="text" name="myCountry" placeholder="Room Type">
					</div>
				</div>
...
var countries = ["Superior Single","Superior Double","Deluxe Single","Deluxe Double","King Single","King Double"];
